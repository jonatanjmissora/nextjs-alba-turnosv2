        ...
        <MobilLayout>
            <section className="flex-1 w-full mx-auto h-[500px] p-2 flex flex-col justify-center gap-12 items-center">
                ...
                <div className="text-sm text-[#444]/80 text-center text-balance">
                    Se enviará un whatsapp con la confirmación y un recordatorio
                    el dia anterior al mismo. En el caso de no poder asistir, o
                    reprogramar el turno, recuerde que se debe notificar 24hs
                    antes. Gracias por elegirme!! 😍
                </div>
            </section>
        </MobilLayout>
    );
